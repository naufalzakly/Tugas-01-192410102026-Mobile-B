...
class MyApp extends StatelessWidget {
    List<Map<String, dynamic>> list_nama = [
    {
      'nama': 'Candra Wulan',
    ...
    {
      'nama': "Muhammad Sultan Hasbie Ashidiqqie",
      'email': 'sultang@gmail.com',
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: ListView(
          children: [
            for (int index = 0; index < list_nama.length; index++)
              Container(
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      backgroundImage: AssetImage('img/${list_nama[index]["foto"]}'),
                      radius: 30,
                    ...
                    Flexible(
                      ...
                      child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text("${list_nama[index]['nama']}",
                              ),
                              Text("${list_nama[index]['email']}",
                              ),
                              Text("${list_nama[index]['nohp']}",
                              ),
                            ],
                          )),
                    )
